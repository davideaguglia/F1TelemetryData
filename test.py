...
# Load prefilled notes from a text file
with open('notes.txt', 'r') as f:
    prefilled_notes = f.read()
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Label('Notes', style={'fontFamily': 'Orbitron', 'marginTop': '15px'}),
            dcc.Textarea(
                id='circuit-textbox',
                value=prefilled_notes,
                style={'width': '100%', 'height': '150px', 'padding': '10px', 'fontFamily': 'Rajdhani', 'borderRadius': '8px'}
            )
        ]), 
